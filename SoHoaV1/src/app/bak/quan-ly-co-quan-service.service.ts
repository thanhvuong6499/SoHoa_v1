...
export class QuanLyCoQuanService {
  ...
  public getListFontByOrganId (condi? : BaseCondition<CoQuan>) {
    var condition = {};
    if (condi != undefined) {
      condition = {
  ...
  return this.httpClient.post<Phong[]>(ApiUrl.apiUrl + 'Font/GetFontByCoQuanID', JSON.stringify(condition), { headers: HttpHeadersOptions.headers });
  }
